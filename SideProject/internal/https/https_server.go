...
// parse a JSON request body(reference: https://www.alexedwards.net/blog/how-to-properly-parse-a-json-request-body)
...
// wrapping your handlers with a closure
//  - 핸들러 내부에 필요한 정보가 있다면 handleRequest() 함수의 인자로 전달하여 Closure 내부에서 사용하도록 함
...
func StartServer(ip string, port int, location string, cert string, key string) {
	...
	http.Handle(location, handleRequest())
